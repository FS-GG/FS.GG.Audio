...
declared paths through the existing plan. Its tests also keep a preexisting
...
rollback, and compare against the accepted Python gate. No staging write should
