...
# Engine-backed audio sink for the raw-backend host path Charter

## Identity
- Work id: `006-host-engine-sink`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 006-host-engine-sink`.
